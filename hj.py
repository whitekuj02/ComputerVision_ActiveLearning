...
wandb.init(
    ...
    name = "(SGD + 증강4개(호리즌탈, 로테30, 가우시안, sobel)따로 (hj))(최고) + 배치 64 + 얼리스탑 + softloss", # 매 실험마다 이름 바꾸어주기
    ...
    "dataset": "CUB2011",
    "augmentation": "RandomHorizontalFlip + andomRotation(30) + GaussianBlur(kernel_size=11) + sobel",
    "epochs": "early stop",
    "batch" : 64
    }
)
